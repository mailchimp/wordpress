...
describe('Validate required fields', () => {
	...
	const requiredFields = [
		{ selector: 'input[id^="mc_mv_FNAME"]', errorMessage: 'You must fill in First Name', input: 'Test' },
		{ selector: 'input[id^="mc_mv_LNAME"]', errorMessage: 'You must fill in Last Name', input: 'User' },
		{
